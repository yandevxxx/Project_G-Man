...
<div class="mb-5">
    ...
    <div class="d-flex align-items-center">
        ...
        <div>
            <h2 class="h3 mb-1 fw-bold tracking-tight">Add New Supplier</h2>
            <p class="text-muted small mb-0">Register a new supplier to manage product sourcing.</p>
        </div>
    </div>
</div>
                ...
                <form action="{{ route('suppliers.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control py-3 px-4 border-start-0 rounded-end-4 @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" placeholder="e.g. PT. Supplier Indonesia" required>
                            @error('name')
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control py-3 px-4 border-start-0 rounded-end-4 @error('contact_person') is-invalid @enderror" id="contact_person" name="contact_person" value="{{ old('contact_person') }}" placeholder="e.g. John Doe">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control py-3 px-4 border-start-0 rounded-end-4 @error('phone') is-invalid @enderror" id="phone" name="phone" value="{{ old('phone') }}" placeholder="+62 812 3456 7890">
                                @error('phone')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" class="form-control py-3 px-4 border-start-0 rounded-end-4 @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email') }}" placeholder="supplier@example.com">
                                @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <textarea class="form-control py-3 px-4 border-start-0 rounded-end-4 @error('address') is-invalid @enderror" id="address" name="address" rows="3" placeholder="Enter full address">{{ old('address') }}</textarea>
                            @error('address')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
