...
@section('content')
    <div class="mb-5">
        ...
        <div class="d-flex align-items-center">
            ...
            <div>
                <h2 class="h3 mb-1 fw-800 tracking-tight text-slate-900">Edit User Account</h2>
                <p class="text-muted fw-500 mb-0">Update account details for: <strong class="text-slate-900">{{ $user->name }}</strong></p>
            </div>
        </div>
    </div>
