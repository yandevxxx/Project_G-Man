...
@section('content')
    <div class="mb-5">
        ...
        <div class="d-flex align-items-center">
            ...
            <div>
                <h2 class="h3 mb-1 fw-800 tracking-tight text-slate-900">Add New Product</h2>
                <p class="text-muted fw-500 mb-0">List a new item in your inventory catalog.</p>
            </div>
        </div>
    </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <textarea class="form-control py-3 px-4 border-start-0 rounded-end-4 @error('description') is-invalid @enderror"
                                    id="description" name="description" rows="4" placeholder="Product details...">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
