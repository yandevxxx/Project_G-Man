    ...
    <div class="card-body p-5">
        ...
        <form action="{{ route('login.authenticate') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="email" class="form-control bg-light border-0 py-2" id="email" name="email" value="{{ old('email') }}" required autofocus>
            </div>
            ...
            <div class="text-center">
                <p class="text-muted small mb-0">Don't have an account? <a href="{{ route('register') }}" class="text-decoration-none fw-semibold">Register</a></p>
            </div>
        </form>
    </div>
</div>
