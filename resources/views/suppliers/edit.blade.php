...
@section('content')
    <div class="mb-5">
        ...
        <div class="d-flex align-items-center">
            ...
            <div>
                <h2 class="h3 mb-1 fw-800 tracking-tight text-slate-900">Edit Supplier</h2>
                <p class="text-muted fw-500 mb-0">Update information for supplier: <strong class="text-slate-900">{{ $supplier->name }}</strong></p>
            </div>
        </div>
    </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <textarea class="form-control py-3 px-4 border-start-0 rounded-end-4 @error('address') is-invalid @enderror"
                                    id="address" name="address" rows="3" placeholder="Enter full address">{{ old('address', $supplier->address) }}</textarea>
                                @error('address')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
