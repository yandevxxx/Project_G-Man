...
<div class="nav flex-column px-3">
    ...
    @if (Auth::user()->role == 'admin')
        ...
        <a href="{{ route('admin.transactions') }}"
            ...
            <i
                class="fas fa-chart-line me-3 fs-5 {{ request()->routeIs('admin.transactions') ? '' : 'text-primary-soft' }}"></i>
    ...
    @else
        ...
        <a href="{{ route('purchases.catalog') }}"
            ...
            <i
                class="fas fa-store me-3 fs-5 {{ request()->routeIs('purchases.catalog') ? '' : 'text-primary-soft' }}"></i>
        ...
        <a href="{{ route('purchases.history') }}"
            ...
            <i
                class="fas fa-history me-3 fs-5 {{ request()->routeIs('purchases.history') ? '' : 'text-primary-soft' }}"></i>
