...
@section('content')
    <div class="mb-5">
        ...
        <div class="d-flex align-items-center">
            ...
            <div>
                <h2 class="h3 mb-1 fw-800 tracking-tight text-slate-900">Edit Category</h2>
                <p class="text-muted fw-500 mb-0">Update information for category: <strong class="text-slate-900">{{ $category->name }}</strong></p>
            </div>
        </div>
    </div>
