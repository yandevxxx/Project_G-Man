...
@section('content')
<div class="mb-5">
    <a href="{{ route('users.index') }}" class="btn btn-link text-decoration-none p-0 mb-3 small fw-bold text-primary transition-all hover-translate-x">
    ...
    <div class="d-flex align-items-center">
        ...
        <div>
            ...
            <p class="text-muted small mb-0">Update information for: <strong class="text-dark">{{ $user->name }}</strong></p>
        </div>
    </div>
</div>
        ...
        <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
            <div class="card-body p-4 p-md-5">
                <form action="{{ route('users.update', $user->id) }}" method="POST">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <label for="role" class="form-label small fw-bold text-uppercase ls-wide text-muted mb-2">Role</label>
                            <div class="input-group">
                                <span class="input-group-text px-3 border-end-0 rounded-start-4"><i class="fas fa-shield-alt"></i></span>
                                <select class="form-select py-3 px-4 border-start-0 rounded-end-4 @error('role') is-invalid @enderror" id="role" name="role" required>
                    ...
                    <div class="mb-4">
                        <label for="pekerjaan" class="form-label small fw-bold text-uppercase ls-wide text-muted mb-2">Job <span class="text-lowercase fw-normal">(optional)</span></label>
                        <div class="input-group">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <textarea class="form-control py-3 px-4 border-start-0 rounded-end-4 @error('alamat') is-invalid @enderror" id="alamat" name="alamat" rows="3" placeholder="Enter full address...">{{ old('alamat', $user->alamat) }}</textarea>
                            @error('alamat')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <a href="{{ route('users.index') }}" class="btn btn-light btn-lg px-4 py-3 text-muted fw-bold border-0 shadow-sm rounded-4">
                            Cancel
                        </a>
                    </div>
                </form>
