...
<div class="mb-5">
    ...
    <div class="d-flex align-items-center">
        ...
        <div>
            <h2 class="h3 mb-1 fw-bold tracking-tight">Edit Product</h2>
            <p class="text-muted small mb-0">Update information for: <strong class="text-dark">{{ $product->name }}</strong></p>
        </div>
    </div>
</div>
                ...
                <form action="{{ route('products.update', $product) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control py-3 px-4 border-start-0 rounded-end-4 @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $product->name) }}" required>
                            @error('name')
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control py-3 px-4 border-start-0 rounded-end-4 @error('stock') is-invalid @enderror" id="stock" name="stock" value="{{ old('stock', $product->stock) }}" min="0" required>
                                @error('stock')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control py-3 px-4 border-start-0 rounded-end-4 @error('price') is-invalid @enderror" id="price" name="price" value="{{ old('price', $product->price) }}" min="0" required>
                            @error('price')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <textarea class="form-control py-3 px-4 border-start-0 rounded-end-4 @error('description') is-invalid @enderror" id="description" name="description" rows="4">{{ old('description', $product->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
