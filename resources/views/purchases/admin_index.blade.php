                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                <div class="bg-light rounded-circle me-2 d-flex align-items-center justify-content-center text-muted fw-bold small" style="width: 32px; height: 32px;">
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                <div class="bg-light rounded text-muted d-flex align-items-center justify-content-center me-2" style="width: 32px; height: 32px;">
                                    <i class="fas fa-box small"></i>
                                </div>
                                <div>
                                    <div class="text-dark fw-medium small">{{ $purchase->product->name ?? 'Unknown Product' }}</div>
                                    <div class="small text-muted" style="font-size: 0.75rem;">Qty: {{ $purchase->quantity }}</div>
                                </div>
                            </div>
                        </td>
                        <td>
